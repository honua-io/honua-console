...
// Vite bakes VITE_* values at build time. The smoke run needs the admin
// link-back to surface for the operator preset, so seed a deterministic value
// here. Production deployments override via their own .env.local / CI secrets.
