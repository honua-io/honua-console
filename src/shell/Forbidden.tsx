...
/**
 * Permission-aware EmptyState. Use whenever a route exists but the active
 * session lacks the required scope. honua-console#3 will refine the copy when
 * the canonical RBAC error template lands.
 */
