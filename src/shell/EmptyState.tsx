...
/**
 * Canonical "no items here" surface for the Console. honua-console#3–#10 must
 * compose `EmptyState`, `Forbidden`, `LoadingShell`, and `ErrorBoundary`
 * rather than invent parallel surfaces for missing items, missing permissions,
 * unsupported service metadata, or unsupported package bindings.
 */
