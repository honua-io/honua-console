...
| Map Viewer (incl. Maputnik saved-map style editor) | `/catalog/maps/:id` (canonical path confirmed by Console #3) | [honua-console#4](https://github.com/honua-io/honua-console/issues/4) | in-progress | `honua-portal/docs/features/MAP_VIEWER_MVP.md`, `honua-portal/smoke/maputnik-style-editor.smoke.md`; Console #9 |
| Saved Web Maps | `/catalog/maps/:id` save/load/duplicate/rename/delete; portal-override style separation | [honua-console#4](https://github.com/honua-io/honua-console/issues/4) | in-progress | `honua-portal/smoke/saved-maps.smoke.md`; `honua-portal/docs/contracts/webmap-doc-v1.md`; Console #9 |
