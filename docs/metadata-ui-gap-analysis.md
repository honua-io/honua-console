...
- **NOT yet done (the complex/niche tail):** subtypes (#11), Arcade attribute rules (#12), publication-level overrides (#17), permanent filter (#18 — server endpoint exists, console not wired), 3D extrusion/symbology (#19), lifecycle status setter (#20). Each is a larger feature on its own.
